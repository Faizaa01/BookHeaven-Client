        ...
        <aside className="w-64 mb-8">
            <div className="sticky top-6 space-y-6">
              ...
              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="text-lg font-semibold mb-4 pb-2 border-b-2 border-rose-300">
                  Categories
                </h3>
                <div className="space-y-2">
                  <label className="flex items-center cursor-pointer hover:text-pink-300">
                    <input
                      type="radio"
                      name="category"
                      value=""
                  ...
                  {categories.map((category) => (
                    <label key={category.id} className="flex items-center cursor-pointer hover:text-pink-300">
                      <input
                        type="radio"
                        name="category"
                        value={category.id}
              ...
              <div className="bg-white p-4 rounded-lg shadow">
                ...
                <div className="space-y-2">
                  <label className="flex items-center cursor-pointer hover:text-pink-400">
                    <input
                      type="radio"
                      name="author"
                      value=""
                  ...
                  {authors.map((author) => (
                    <label key={author.id} className="flex items-center cursor-pointer hover:text-pink-400">
                      <input
                        type="radio"
                        name="author"
                        value={author.id}
