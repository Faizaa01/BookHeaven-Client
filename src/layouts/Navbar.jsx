    ...
    return (
        <div>
            ...
            <div className="navbar-start">
                ...
                <div tabIndex={0} role="button" className="lg:hidden text-gray-800 ml-2">
                ...
                <ul
                    ...
                    <li className="mb-1">
                        <Link to="/membership" className="text-gray-800 hover:bg-rose-100 hover:text-rose-800 font-medium py-3 px-4 transition-all duration-200">
                            Membership
                        </Link>
                    </li>
                    <li>
                ...
                <a className="btn btn-ghost text-stone-700 text-3xl gap-2 lg:ml-6"> <BookHeart className='size-8 text-rose-300'/> BOOK HEAVEN</a>
            </div>
            <div className="navbar-end">
                <ul className="menu menu-horizontal px-1 hidden md:flex lg:mr-10 lg:gap-4">
                    <li>
                    ...
                    <li>
                        <Link to="/membership" className="text-stone-500 hover:text-stone-800 text-lg px-2 py-2 flex items-center gap-2 border-b-2 border-transparent hover:border-stone-800 transition-colors">
                            MEMBERSHIP
                        </Link>
                    </li>
                    <li>
                ...
                <div className="flex-none">
                    ...
                    <ul
                        tabIndex="-1"
                        className="menu menu-sm dropdown-content bg-rose-50 z-1 mt-3 w-52 p-3 shadow text-gray-700">
                        <li className="mb-1">
                        <Link to="profile" className="hover:text-red-400 font-medium py-3 px-3 transition-all duration-200 flex items-center gap-3">
                            My Profile
                        </Link>
                        </li>
                        <li className="mb-1">
                            <Link to="borrowrecord" className="hover:text-red-400 font-medium py-3 px-3 transition-all duration-200 flex items-center gap-3">
                                Borrow Records
                            </Link>
                        </li>
                        {user.is_staff && (
